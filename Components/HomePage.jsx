...
function HomePage() {
  return (
    ...
    >
      ...
      />
      <div className="InterfaceInfo w-fit text-center lg:translate-y-[18vh] md:translate-y-[23vh] lg:bg-transparent md:bg-white/50 md:backdrop-blur-[10px] lg:p-0 md:p-[15px] md:pb-[15px] mx-auto md:rounded-[10px] lg:transition-none lg:hover:scale-[1] md:hover:scale-[1.02] md:transition-all md:transition-linear md:duration-500 translate-y-[17vh] mdx:text-textColor mdx:w-[70vw] mdx:rounded mdx:backdrop-blur-[10px] mdx:p-[10px] cursor-pointer">
        <h2 className="lg:text-[2rem] md:text-[1.5rem] lg:text-textColor md:text-toolsBarColor text-center font-[600] lg:leading-[4rem] md:leading-[2rem]">
          Hi There!
        </h2>
        <div className="namHead flex items-center w-fit mx-auto lg:mb-[40px] md:mb-[20px] gap-[20px]">
          <span className="lg:text-textColor md:text-toolsBarColor text-[2.2rem] no-underline font-[600] mdx:text-[1.5rem] mdx:mb-[15px]">
            {"I'm"}
          </span>
          <h1 className="lg:text-textColor md:text-toolsBarColor lg:text-[40px] md:text-[30px] font-bold lg:leading-[3rem] md:leading-[2rem] border-b-2 bprder-solid lg:border-white md:border-toolsBarColor pb-0 mdx:text-[1.5rem] mdx:mb-[15px]">
            Theo Code
          </h1>
        </div>
        <p className="lg:w-[490px] p-[10px] md:w-[350px] lg:text-textColor md:text-toolsBarColor lg:text-[1.4rem] md:text-[1.2rem] md:font-[480] text-center mx-auto mdx:text-[1.1rem]">
