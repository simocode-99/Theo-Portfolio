...
function IconsBox() {
  return (
    <div
      className={`w-fit flex absolute top-[80vh] left-[50%] md:-translate-x-[50%] 2xl:gap-[40px] xl:gap-[30px] lg:gap-[30px] md:gap-[25px] rounded-[30px] backdrop-blur-[10px] mdx:flex-col mdx:left-[20px] mdx:top-auto mdx:bottom-[20px] mdx:gap-[20px]`}
    >
      <a
